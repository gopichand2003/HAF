...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (signUp) {
        signUp.addEventListener('click', async (event) => {
            ...
            if (!acceptTerms) {
                showMessage('Please accept the Terms & Conditions to continue', 'signUpMessage');
                return;
            }
            ...
            try {
                ...
                const userData = {
                    ...
                    expiresAt: Date.now() + 30000 // 5 minute from now
                };
                ...
                showMessage('Please verify your email within 5 minute.', 'signUpMessage', true);
